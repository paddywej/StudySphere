...
def quiz_item(name: str, due_date: str, status: str, quiz_time: str, quiz_id: str) -> rx.Component:
...
def quiz() -> rx.Component:
    ...
    quizzes_list = [
        {"id": "math_quiz", "name": "Math Quiz", "due_date": "2025-03-29", "status": "new", "quiz_time": "15:00 PM - 16:00 PM"},
        {"id": "science_quiz", "name": "Science Quiz", "due_date": "2025-04-02", "status": "done", "quiz_time": "10:00 AM - 11:00 AM"},
        {"id": "history_quiz", "name": "History Quiz", "due_date": "2025-03-25", "status": "new", "quiz_time": "12:00 PM - 1:00 PM"},
        ...
        rx.hstack(  # Create a horizontal stack (two columns)
            rx.box(  # Quizzes (including both new and done)
                rx.vstack(
                    ...
                    *[quiz_item(quiz["name"], quiz["due_date"], quiz["status"], quiz["quiz_time"], quiz["id"]) for quiz in quizzes_list],
