...
app.add_page(assignment_details_page, route="/assignment_details")
...
app.add_page(quiz_detail_page, route="/quiz_details")
app.add_page(exam_page, route="/exam")
app.add_page(exam_detail_page, route="/exam_details")
